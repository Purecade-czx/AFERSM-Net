...
class BasicBlock(nn.Module):           #继承nn.Module父类
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        # self.conv2 = nn.Conv1d(planes, planes * BasicBlock.expansion, kernel_size=3, stride=1, padding=1, bias=False)
...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        # x = torch.reshape(x,(-1,520))
        # #print('the x1 is:',x.shape)
        # c0 = self.sae(x)
        # c0 = c0.unsqueeze(1)
        # #print('the c0 is:',c0.shape)
